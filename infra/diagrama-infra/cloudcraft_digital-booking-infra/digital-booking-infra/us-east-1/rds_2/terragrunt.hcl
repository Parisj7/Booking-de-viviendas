...
dependencies {
  paths = ["../digital-booking-vpc", "../sg-db"]
}
...
inputs = {
  ...
  # type: string
  db_subnet_group_name = dependency.digital-booking-vpc.outputs.database_subnet_group
